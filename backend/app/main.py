...
from app.models import patient, service, appointment, product, promotion, sale, document, expense, stock_movement  # noqa: F401 — registers models
from app.routes import auth, patients, services, appointments, metrics, analytics, products, promotions, sales, public, documents, expenses, runway
